...
get_image_encode_pb2 = importlib.import_module(
    f"{__name__}.{_close_grpc_version}.vlm_chat_pb2"
)
get_image_encode_pb2_grpc = importlib.import_module(
    f"{__name__}.{_close_grpc_version}.vlm_chat_pb2_grpc"
)
...
# NOTE: 方便写代码用
from .v1_68_1 import vlm_chat_pb2,vlm_chat_pb2_grpc # noqa
__all__ = ["vlm_chat_pb2", "vlm_chat_pb2_grpc"]
